...
// csv import & format data 
  ...
  d3.csv("static/js/nba_coaches_2.csv").then(function(nbaData) {
    ...
    var toolTip = d3.tip()
      ...
      .offset([65, 0])
      .html(function(d,k) {
        return (`Number of Coaches: ${d.White}`);
      });
    ...
    chartGroup.append("text")
      .attr("transform", `translate(${chartwidth / 2}, ${yMax - 30})`)
      .attr("class", "title")
      .text("NBA Coaches by Ethnicity")
    ...
    var legends = svg.append("g")
          .attr("transform", `translate(${chartwidth + 20}, ${yMax - 20})`)
          .selectAll(".legends")
