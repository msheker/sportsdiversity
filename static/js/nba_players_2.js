...
// csv import & format data 
  ...
  d3.csv("static/js/nba_players_2.csv").then(function(nbaData) {
    ...
    var toolTip = d3.tip()
      ...
      .offset([65, 0])
      .html(function(d,k) {
        return (`Number of Players: ${d.White}`);
      });
    ...
    chartGroup.append("text")
      .attr("transform", `translate(${chartwidth / 2}, ${yMax - 375})`)
      .attr("class", "title")
      .text("NBA Players by Ethnicity")
